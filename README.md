...
## Solution
 - EmployeeId is Auto incremented DB generated field.
 - Address and Employee table has Primary-Foreign Key relationship.
 - Using JDBC for DB connectivity and RestAssured for Functional Testing.
